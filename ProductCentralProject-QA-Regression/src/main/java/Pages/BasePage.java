...
public class BasePage extends HelperFunctions {
	...
	@FindBy(xpath="//a[@href='/us/en/privacy.html']")
	private static WebElement privacyLink;
	
	@FindBy(xpath="//a[@href='/us/en/accessibility.html']")
...
public static void setVerifySeperatePages() throws Exception {
	HelperFunctions.waitForPageToLoad(3);
	JavascriptExecutor executor12 = (JavascriptExecutor) Driver.getDriver();
...
public static void setCollapseButtonImg() throws Exception {
	HelperFunctions.staticWait(3);
	JavascriptExecutor executor = (JavascriptExecutor) Driver.getDriver();
     executor.executeScript("arguments[0].click();", collapseButton);
	for(WebElement items:leftNavigationItems) {
...
public static void setCollapseExpandButton() throws Exception {
	HelperFunctions.staticWait(3);
	JavascriptExecutor executor = (JavascriptExecutor) Driver.getDriver();
     executor.executeScript("arguments[0].click();", collapseButton);
	HelperFunctions.staticWait(3);
...
public static void setVerifyFooter() throws Exception {
	HelperFunctions.waitForPageToLoad(3);
	HelperFunctions.staticWait(2);
